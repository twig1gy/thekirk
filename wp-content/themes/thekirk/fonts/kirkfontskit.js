/*
 ...
 MyFonts Webfont Build ID 3440330, 2017-08-21T20:24:10-0400
 ...
 License: https://www.myfonts.com/viewlicense?type=web&buildid=3440330
 ...
 ? 2017 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/347eca";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0,woff2Enabled=0;
...
/(Macintosh|Android)/.test(navigator.userAgent)&&"svg#wf"!=webfontType&&(suffix="_unhinted");var head=document.getElementsByTagName("head")[0],stylesheet=document.createElement("style");stylesheet.setAttribute("type","text/css");head.appendChild(stylesheet);var fonts=[{fontFamily:"TradeGothicLTPro-Cn18",url:wfpath+"347ECA_0"+suffix+"_0."+webfontType},{fontFamily:"TradeGothicLTPro-BdCn20",url:wfpath+"347ECA_1"+suffix+"_0."+webfontType}],len=fonts.length,data_fn;
"ttf"==webfontType?data_fn="_unhinted"==suffix?"347ECA_data_unhintedttf.css":"347ECA_datattf.css":"woff"==webfontType&&(data_fn="_unhinted"==suffix?"347ECA_data_unhintedwoff.css":"347ECA_datawoff.css");var link=document.createElement("link");link.setAttribute("rel","stylesheet");link.setAttribute("type","text/css");link.setAttribute("href",wfpath+data_fn);head.appendChild(link);
